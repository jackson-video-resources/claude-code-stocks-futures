# Claude Code for Stocks & Futures | Full Course | Build and Earn 2026

> Build a fully automated trading system for Forex, Futures & Stocks using Claude Code and Alpaca — no coding experience required.
...
- Pulls real-time price data from Alpaca for any stock, futures contract, or Forex pair
...
- Places and manages orders on Alpaca without you touching anything
- Runs 24/7 on a server via PM2, restarts itself after crashes, and sends Telegram alerts when it trades
- Retrains its own parameters using an automated ML loop — you set it running, it improves itself overnight
- Scales to multiple markets and multiple strategies running in parallel

You write no code. You describe what you want in plain English. Claude Code builds it.
...
|---|--------|----------|----------------|
| 1 | **Setup & Foundation** | 4 | Claude Code installed, Alpaca connected, project structured |
| 2 | **Market Data & Signal Generation** | 3 | Live price feed via websocket, EMA crossover signal engine |
...
| 5 | **Paper Trading Execution** | 4 | Full system wired to Alpaca, first automated paper trade |
| 6 | **Going Live** | 3 | Risk management rules, live credentials, first real trade |
| 7 | **Automation & Resilience** | 4 | PM2 deployment, Telegram alerts, self-healing error handling |
...
| 1.4 | Connecting to Alpaca |

### Module 2 — Market Data & Signal Generation

| Section | Title |
|---------|-------|
| 2.1 | Connecting to Live Market Data |
...
| 4.3 | Running Your First Backtest With Claude Code |
...
| 5.2 | Building the Execution Layer |
...
All Claude Code prompts used in the course are in the [`prompts/`](./prompts/) folder — one file per module. Copy them directly into Claude Code at the relevant point in the course.
